                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="post">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" id="nik" name="nik" placeholder="Enter your NIK" autofocus pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" />
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama Lengkap</label>
                                <input required type="text" class="form-control" id="nama" name="nama" placeholder="Enter your full name" autofocus />
                            </div>
                            <div class="mb-3">
                                <label for="username" class="form-label">Username</label>
                                <input required type="text" class="form-control" id="username" name="username" placeholder="Enter your username" autofocus />
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>We value your privacy and are committed to protecting your personal information. This privacy policy outlines how we collect, use, disclose, and protect your information.</p>

                                <h6>2. Information Collection</h6>
                                <p><b>Personal Information:</b></p>
                                <p>We may collect personal information such as your name, email address, phone number, and other details you provide.</p>
                                <p><b>Usage Data:</b></p>
                                <p>We may collect information about how you access and use our services, including your IP address, browser type, and usage patterns.</p>
                                ...
                                <p><b>Improvement:</b></p>
                                <p>To understand how our services are used and to improve them.</p>

                                <h6>4. Information Sharing</h6>
                                <p><b>Third-Party Services:</b></p>
                                <p>We may share your information with third-party service providers who assist us in operating our services.</p>
                                ...
                                <h5 class="mb-2">Terms of Service</h5>

                                <h6>1. Introduction</h6>
                                <p>These terms of service govern your use of our services. By accessing or using our services, you agree to be bound by these terms.</p>

                                <h6>2. Use of Services</h6>
                                <p><b>Eligibility:</b></p>
                                <p>You must be at least [minimum age] to use our services.</p>
                                <p><b>Account:</b></p>
                                ...
                                <p>You agree not to use our services for any unlawful or prohibited activities.</p>

                                <h6>3. User Content</h6>
                                <p><b>Responsibility:</b></p>
                                <p>You are solely responsible for the content you upload, post, or otherwise transmit through our services.</p>
                                <p><b>License:</b></p>
                                <p>By submitting content, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, and distribute your content.</p>

                                <h6>4. Intellectual Property</h6>
                                <p><b>Ownership:</b></p>
                                <p>We retain all rights, title, and interest in our services and content.</p>
                                <p><b>License:</b></p>
                                <p>We grant you a limited, non-exclusive, non-transferable license to access and use our services for personal use.</p>
                                ...
                                <h6>6. Termination</h6>
                                <p>We may terminate or suspend your access to our services at any time, without prior notice, for any reason, including violation of these terms.</p>
