                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card mx-auto">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <img class="img-fluid d-flex mx-auto my-4 rounded" src="../assets/img/avatars/1.png" alt="Card image cap" />
                                            </div>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control-plaintext" type="text" value="NIK" id="html5-nik-input" readonly="" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="html5-username-input" class="col-md-2 col-form-label">Username</label>
                                            <div class="col-md-10">
                                                <input class="form-control-plaintext" type="text" value="username" id="html5-username-input" readonly="" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="html5-nama-input" class="col-md-2 col-form-label">Nama Lengkap</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" value="Nama Lengkap" id="html5-nama-input" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control-plaintext" type="text" value="nama_file_lama" id="html5-filecv-input" readonly="" />
                                                <input class="form-control" type="file" id="html5-filecv-input" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="html5-fileporto-input" class="col-md-2 col-form-label">Dokumen Portofolio</label>
                                            <div class="col-md-10">
                                                <input class="form-control-plaintext" type="text" value="nama_file_lama" id="html5-fileporto-input" readonly="" />
                                                <input class="form-control" type="file" id="html5-fileporto-input" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="password" value="john@example.com" id="html5-pass-input" />
                                            </div>
                                        </div>
                                        <div class="row">
